...
function addVehicle($invMake, $invModel, $invDescription, $invImage, 
        $invThumbnail, $invPrice, $invStock,$invColor, $classificationId){
    // Create a connection object using the phpmotors connection function
    $db = phpmotorsConnect();
    // The SQL statement
    $sql = 'INSERT INTO inventory (invMake, invModel, invDescription, invImage, 
    invThumbnail, invPrice, invStock, invColor, classificationId)
   ...
   function addClasssification($classificationName){
       // Create a connection object using the phpmotors connection function
    $db = phpmotorsConnect();
    // The SQL statement
...
function getInvItemInfo($invId){
   ...
   //Get list of vehicles by claasification name
...
function getVehiclesDetail($vehicles){
    foreach($vehicles as $vehicle){
    $db = phpmotorsConnect();
    $sql = 'SELECT * FROM images WHERE invId =:invId AND locate("-tn",imgName)' ;
    $stmt = $db->prepare($sql);
